...
<html>
  <head>
    ...
    <title>
      <?php echo (active_project() instanceof Project) ? clean(active_project()->getName()) : get_page_title() ?> @ <?php echo $owner_company_name ?>
    </title>
      ...
      $('.openTasks ul').sortable({
        ...
        update:
          function(event, ui) {
            ...
            $.get('<?php echo html_entity_decode(get_url('task', 'reorder')) ?>', {task_list_id: task_list_id, order: order});
          }
      });
